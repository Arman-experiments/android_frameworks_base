...
enum class WidgetAction(
    val activeRes: Int,
    val inactiveRes: Int,
    val onClick: (LockScreenWidgetController.ViewController) -> Unit,
    val onLongClick: ((LockScreenWidgetController.ViewController, View) -> Boolean)? = null,
    val registerCallback: (LockScreenWidgetController.ViewController) -> Unit = {},
    val unregisterCallback: (LockScreenWidgetController.ViewController) -> Unit = {}
) {
    WIFI(
